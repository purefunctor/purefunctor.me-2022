...
render _ =
  ...
  [ HH.div [ css "grid grid-cols-2 grid-rows-2 flex-1 gap-5" ]
    [ HH.div [ css "box-content row-span-2 p-5 text-left text-6xl bg-opacity-20 bg-gray-900 border-4 border-gray-900" ]
      [ HH.text "PureFunctor"
      ]
    , HH.div [ css "box-content text-left p-5 text-6xl bg-opacity-20 bg-gray-900 border-4 border-gray-900" ]
      [ HH.text "Projects"
      ]
    , HH.div [ css "box-content text-left p-5 text-6xl bg-opacity-20 bg-gray-900 border-4 border-gray-900" ]
      [ HH.text "Socials"
